...
const DesktopHeader = () => {
  ...
  const navItems = [
    ...
    ...(user && (user.role === "admin" || user.role === "astrologer")
      ? [{ to: "/astrology", icon: Star, label: "Rasi Chart" }]
      : []),
  ...
  return (
    <header
      className="hidden md:block sticky top-0 z-50 border-b border-white/10"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute w-1 h-1 bg-purple-300 rounded-full top-6 right-1/3 animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute w-0.5 h-0.5 bg-white rounded-full top-8 left-2/3 animate-pulse"
          ...
          <Link to="/" className="flex items-center gap-3 group relative">
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(to right, #d4af37, ${theme.hex})`,
                }}
              ></div>
            ...
            <div className="flex flex-col">
              ...
              <p className="text-xs text-purple-300 tracking-widest">
                ✨ DIVINE GUIDANCE ✨
              </p>
            </div>
          </Link>
            ...
            {user ? (
                  ...
                  <Link
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, #d4af37 0%, #f4e5c2 50%, #d4af37 100%)",
                      boxShadow:
                        "0 4px 15px rgba(212, 175, 55, 0.4), 0 0 20px rgba(212, 175, 55, 0.3)",
                      color: "#2d1b4e",
                    }}
                  >
                    <Wallet size={16} />
              ...
              <>
                ...
                <Link
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #d4af37 0%, #f4e5c2 100%)",
